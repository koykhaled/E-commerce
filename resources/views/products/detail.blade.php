...
@section('content')
    ...
    <body class=" detail page ">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                <li class="item-link"><a href="{{ route('products.index') }}" class="link">home</a></li>
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-butons">
                            <a href="#" class="btn add-to-cart"
                                wire:click.prevent="store({{ $product->id }},'{{ $product->name }}',{{ $product->reqular_price }})">Add
                                to Cart</a>
                            <div class="wrap-btn">
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">01 review for
                            ...
                            @foreach ($related_products as $r_product)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('prdoucs.detail', $r_product->slug) }}"
